...
public class ViewSalaryOverviewByEmpActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hourSalary = EmployeeActivity.hourSalary;
    ...
    private void getRecord(String shiftDate) {
        ...
        if(date.size()>0){
            ...
            AssignmentListAdapter adapter = new AssignmentListAdapter(ViewSalaryOverviewByEmpActivity.this, date);
            recyclerDate.setAdapter(adapter);
            AssignmentListAdapter adapter2 = new AssignmentListAdapter(ViewSalaryOverviewByEmpActivity.this, checkedIn);
            recyclerCheckedIn.setAdapter(adapter2);
            AssignmentListAdapter adapter3 = new AssignmentListAdapter(ViewSalaryOverviewByEmpActivity.this, checkedOut);
            recyclerCheckedOut.setAdapter(adapter3);
            AssignmentListAdapter adapter4 = new AssignmentListAdapter(ViewSalaryOverviewByEmpActivity.this, hours);
            recyclerHours.setAdapter(adapter4);
            AssignmentListAdapter adapter5 = new AssignmentListAdapter(ViewSalaryOverviewByEmpActivity.this, pay);
            recyclerPay.setAdapter(adapter5);

            tvTotal.setText("(Total Payable Amount : $"+totalSalary+")");
        }else {
            textView.setText("No Data om Selected Month and Year!");
        }
    }
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    list.add(model);
                    if(userId.equals(model.getEmpId())  && str.equals(model.getStatus())){
                        Date d = model.getDate();
                        SimpleDateFormat sdf2 = new SimpleDateFormat("dd-MM-yyyy");
                        String sDate = sdf2.format(d);
                        String[] arr2 = sDate.split("-");
