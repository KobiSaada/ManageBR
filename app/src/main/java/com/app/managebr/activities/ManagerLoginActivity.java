...
public class ManagerLoginActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!isConnectionAvailable(ManagerLoginActivity.this)){
                    Toast.makeText(ManagerLoginActivity.this, "Check your network!", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void checkUserType(String userId) {
        final DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("ManagersData").child(userId);
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.getChildrenCount()>0){
                    ...
                    Toast.makeText(ManagerLoginActivity.this, "Sign in successful", Toast.LENGTH_SHORT).show();
                    hideProgressDialog();
