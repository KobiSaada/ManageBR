...
public class ViewUpcomingShiftsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_upcoming_shifts);
    ...
    //Get all the upcoming shiftsfrom firebase in this function and set them up in a list..
    @Override
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(list.size()>0){
                    ...
                    ShiftssListAdapter adapter = new ShiftssListAdapter(ViewUpcomingShiftsActivity.this, list);
        ...
        public void onBindViewHolder(final ImageViewHolder holder, @SuppressLint("RecyclerView") final int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(ViewUpcomingShiftsActivity.this);
                    builder.setTitle("Confirmation?");
                    builder.setMessage("Are you sure to delete this shift?").setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        @Override
