            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    if(SelectionActivity.key.equals("Manager")){
                        ...
                        ManagerModelCLass model = new ManagerModelCLass(userId,"","",email,"","",password,"",SelectionActivity.key,false);
                        ...
                        EmployeeModelCLass model = new EmployeeModelCLass(userId,"","",email,"","",password,
                                "",SelectionActivity.key,false,"",0f);
                        databaseReference.child(userId).setValue(model);
                    }
