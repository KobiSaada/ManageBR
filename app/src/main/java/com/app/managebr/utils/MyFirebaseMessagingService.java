...
import com.app.managebr.activities.SplashActivity;
import com.google.firebase.messaging.FirebaseMessagingService;
import com.google.firebase.messaging.RemoteMessage;

//MyFirebaseMessagingService built in class to recieve notifications in app and displaying it to user
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void show(String msg, String title) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            builder.setSmallIcon(R.mipmap.ic_launcher_round).setContentTitle(title)
                    .setContentText(msg)
                    .setAutoCancel(true)
